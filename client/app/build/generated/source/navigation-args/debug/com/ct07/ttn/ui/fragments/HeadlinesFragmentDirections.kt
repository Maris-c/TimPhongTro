...
public class HeadlinesFragmentDirections private constructor() {
  private data class ActionHeadlinesFragmentToRoomFragment(
    public val room: Room
  ) : NavDirections {
    public override val actionId: Int = R.id.action_headlinesFragment_to_roomFragment
  ...
  public companion object {
    public fun actionHeadlinesFragmentToRoomFragment(room: Room): NavDirections =
        ActionHeadlinesFragmentToRoomFragment(room)
  }
}
