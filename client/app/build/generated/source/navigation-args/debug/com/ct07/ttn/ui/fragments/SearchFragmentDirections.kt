...
public class SearchFragmentDirections private constructor() {
  private data class ActionSearchFragmentToRoomFragment(
    public val room: Room
  ) : NavDirections {
    public override val actionId: Int = R.id.action_searchFragment_to_roomFragment
  ...
  public companion object {
    public fun actionSearchFragmentToRoomFragment(room: Room): NavDirections =
        ActionSearchFragmentToRoomFragment(room)
  }
}
